...
#    fillColor: "rgba(0,0,0,0.025)"
  ...
  MinuteTicks = 
    ...
    innerRadius: ClockRadius - Clock.scale * 6
    degrees: 6
    lineWidth: 0.6
  ...
  HourTicks = 
    outerRadius: ClockRadius
    innerRadius: ClockRadius - Clock.scale * 8
    degrees: 30
    lineWidth: 1.5
    strokeColor: "rgba(248,106,36,1)"

  Frame = 
    outerRadius: ClockRadius
    innerRadius: ClockRadius - Clock.scale * 1.0
    fillColor: "rgba(255,255,255,1.0)"
    
  SecondHand = 
    length: ClockRadius * 1.1
    width: .5
    fillColor: "rgba(248,106,36,1)"
  ...
  HandCover =
    radius: HourHand.width * 3.5
    lineWidth: 0.6
    fillColor: "rgba(255,255,255,1.0)"
    strokeColor: "rgba(248,106,36,1.0)"
    shadowOffset: 2
  ...
  Label =
    ...
    text: theDate.toLocaleDateString('nl-NL')  #"Amsterdam"
